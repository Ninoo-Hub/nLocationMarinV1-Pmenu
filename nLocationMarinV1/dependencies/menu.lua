...
print("^1======================================================================^1")
print("^2[^4Location by^2] ^7: ^2 Ninoo#9999^2") --Thank you for not changing the name to put yours and tell everyone that it was you who created the script
...
function CMenu:drawMenuButton(button, intX, intY, boolSelected, intW, intH, intID)
	...
	tableColor = boolSelected and {255, 255, 255} or {255, 255, 255}
...
print("^8======================================================================^8")
print("^5[^5Discord^5] ^1: ^1 https://discord.gg/9jUAAwb^1")
print("^8======================================================================^8")
